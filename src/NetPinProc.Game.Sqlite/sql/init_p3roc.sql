...
('A0-R0-G1-B2', 'LED1', '', 1,  'start'),
('A0-R3-G4-B5', 'LED2', '', 1,  ''),
('A0-R6-G7-B8', 'LED3', '', 1,  'shootAgain'),
...
('09', 'flipperLwL', 0, '', '', 'closed','flipper'),
('11', 'flipperLwR', 0, '', '', 'closed','flipper'),
('13', 'flipperUpL', 0, '', '', 'closed','flipper'),
('15', 'flipperUpR', 0, '', '', 'closed','flipper'),
...
('24', 'trough3', 0, 'trough,troughEject', '', 'closed', 'opto'),
-- board 1/B
...
('30', 'slingL', 0, 'sling', 'open', '', 'bumper'),
('31', 'slingR', 0, 'sling', 'open', '', 'bumper'),
